...
This is the Repo for the official [feuerstein.dev](https://feuerstein.dev) website. It's built using [docusaurus](https://docusaurus.io). The real Webseite is built from this Repo,automatically via Github Actions. Github Actions will push it to the Webserver after the building process. If you find any wrong information or information that seems wrong, please make sure to contact me, or open a issue on this [Github repo](https://github.com/einfeuerstein/feuerstein.dev). I hope you'll have fun with the content on my website.
